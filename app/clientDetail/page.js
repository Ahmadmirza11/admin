        ...
        <div className="bg-white rounded-lg p-10 mt-10 shadow-2xl">
          ...
          <div className="flex justify-between border-b border-gray-500 mt-9">
            ...
            <div className="flex-1 ">
              ...
              {/*  */}
              <div className="flex  items-center space-x-16 bg-gray-300 p-2 mt-4 rounded-lg ml-20">
              ...
              {/*  */}
              <div className="flex  items-center space-x-16 bg-gray-300 p-2 mt-4 rounded-lg ml-20 mb-6">
                <p className="text-sm">pdf</p>
                <div className="flex items-center space-x-3">
                  <Image src={pic2} alt="aj" />
                  <p className="text-gray-500">company tax draft</p>
          ...
          <button className="text-white bg-blue-400 rounded-lg py-2 w-full" onClick={nextpg}>save</button>
          </div>
            </div>
          </div>

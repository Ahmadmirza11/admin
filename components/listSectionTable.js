...
const ListSectionsTable = () => {
  return (
    <div className='mt-10'>
      <div className='bg-white p-5 shadow-xl rounded-xl'>
        <div className='flex justify-between mb-4'>
          <p className='text-xl font-bold'>List Sections</p>
          ...
          <table className='min-w-full bg-white'>
            ...
            <tbody>
              <tr className='border-b'>
                ...
                <td className='py-3 px-3 text-left text-gray-600'>Manage Your Reports <br /> And Analytics</td>
                <td className='py-3 px-3 text-left text-gray-600'>All In One Accounting Solutions</td>
                <td className='py-3 px-3 text-right'>
                  <button className='mx-1 bg-blue-400 rounded-full p-1 text-white'>
              ...
              <tr className='border-b'>
                ...
                <td className='py-3 px-3 text-left text-gray-600'>Easily Customizable <br /> & Manage Your Team</td>
                <td className='py-3 px-3 text-left text-gray-600'>All In One Accounting Solutions</td>
                <td className='py-3 px-3 text-right'>
                  <button className='mx-1 bg-blue-400 rounded-full p-1 text-white'>
                    <FontAwesomeIcon icon={faEdit} />
              ...
              <tr>
                ...
                <td className='py-3 px-3 text-left text-gray-600'>We are Making Accounting <br /> Easy For Everyone</td>
                <td className='py-3 px-3 text-left text-gray-600'>All In One Accounting Solutions</td>
                <td className='py-3 px-3 text-right'>
                  <button className='mx-1 bg-blue-400 rounded-full p-1 text-white'>
                    <FontAwesomeIcon icon={faEdit} />
...
export default ListSectionsTable

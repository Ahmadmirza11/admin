...
const HeroSectionSetting = () => {
  return (
    <div>
      <div className='bg-white p-10 rounded-lg mt-10 shadow-2xl'>
        <p className='text-xl font-bold'>Hero Section Setting</p>
      ...
      <div className='mb-4 flex space-x-10 items-center'>
            ...
            {/*  title*/}
            <div className='mb-4'>
              <label className='font-semibold mb-2 block'>Hero Title 2</label>
            ...
            <div className='flex-1 ml-10'>
              {/* title */}
              <div className='mb-16'>
              <label className='font-semibold mb-2 block'>Hero Title 1</label>
              <input className='border rounded-lg p-2 w-full border-gray-500' placeholder='Enter Here'/>
            </div>
            {/* tag line */}
            <div className='mb-4 '>
              <label className='font-semibold mb-2 block'>Tag Line</label>
              <input className='border rounded-lg p-2 w-full border-gray-500' placeholder='Enter Here'/>
            </div>
            {/* button */}
...
export default HeroSectionSetting